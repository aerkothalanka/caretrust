...
function VerificationForm({ facility, service, serviceLabel, facilities, location, onVerified, onHistory, verification, verifying, onVerifySources }) {
...
function App() {
  ...
  const selectFacilityForReview = (uniqueId) => { const facility = displayFacilities.find((f) => f.unique_id === uniqueId); if (facility) { setSelected(facility); setTrustVerification(null); } };

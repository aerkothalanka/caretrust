...
function AppHeader({ activeTab, setActiveTab, onPlayVoice }) {
  return <header className="topbar">
    <div className="brandNav">
      <div className="brandBlock"><div className="brand">Care<span>Signal</span></div></div>
